...
def main():
    """
    Función principal para ejecutar el scraper de Fotocasa para viviendas,
    guardar los datos en un archivo JSON y medir el tiempo de ejecución.
    """
    start_time = time.time()
    
    # URL de inicio para la búsqueda de viviendas en Dénia
    start_url = "https://www.fotocasa.es/es/comprar/viviendas/denia/todas-las-zonas/l"
    
    # Ejecutar el scraper 
    properties = scrape_fotocasa_selenium(start_url, property_type="viviendas", sort_by="publicationDate")
    ...
    if properties:
        ...
        save_to_json(properties, property_type="viviendas", location="denia", output_dir=output_dir)
