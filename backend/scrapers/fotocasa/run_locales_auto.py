...
def main():
    """
    Función principal para ejecutar el scraper de Fotocasa para locales (AUTO),
    ...
    properties = scrape_fotocasa_selenium(start_url, property_type="locales", sort_by="publicationDate", max_pages=1)
